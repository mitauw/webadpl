...
<div class="bgded overlay" style="background-image:url('asset/images/demo/backgrounds/graha.jpg');"> 
  <!-- ################################################################################################ -->
  <div class="wrapper">
  ...
  <main class="hoc container clear"> 
    ...
    <ul class="nospace clear services">
      <li class="one_quarter first"><a href="#">
        <figure><img src="asset/images/demo/gallery/1.png" alt="">
          <figcaption>Spesialis Keamanan Siber</figcaption>
        </figure>
        </a></li>
      <li class="one_quarter"><a href="#">
        <figure><img src="asset/images/demo/gallery/2.png" alt="">
          <figcaption>Spesialis IoT</figcaption>
        </figure>
        </a></li>
      <li class="one_quarter"><a href="#">
        <figure><img src="asset/images/demo/gallery/3.png" alt="">
          <figcaption>Analis Keamanan Aplikasi</figcaption>
        </figure>
        </a></li>
      <li class="one_quarter"><a href="#">
        <figure><img src="asset/images/demo/gallery/4.png" alt="">
          <figcaption>Pengembang Layanan Awan</figcaption>
        </figure>
        </a></li>
      <li class="one_quarter first"><a href="#">
        <figure><img src="asset/images/demo/gallery/5.png" alt="">
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('asset/images/demo/backgrounds/lab.jpg');">
  <div class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="testimonial clear">
      <blockquote>Mengapa Teknologi informasi ?</blockquote>
      <figure><img class="circle" src="asset/images/demo/tanyat.jpg" alt="">
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="latest">
      <article class="clear">
        <div class="one_half first"><a class="iblock borderedbox inspace-10" href="#"><img src="asset/images/demo/wiranto.jpg" alt=""></a></div>
        <div class="one_half">
          <h3 class="heading"></h3>
      ...
      <article class="clear">
        ...
        <div class="one_half"><a class="iblock borderedbox inspace-10" href="#"><img src="asset/images/demo/rudiantara.jpg" alt=""></a></div>
      </article>
    </div>
    <div class="btmspace-50 center">
    ...
    <div class="latest">
      <article class="clear">
        <div class="one_half first"><a class="iblock borderedbox inspace-10" href="#"><img src="asset/images/demo/john.jpg" alt=""></a></div>
        <div class="one_half">
          <h3 class="heading"></h3>
          <ul class="nospace meta">
            <li>
      ...
      <article class="clear">
        ...
        <div class="one_half"><a class="iblock borderedbox inspace-10" href="#"><img src="asset/images/demo/bill.jpg" alt=""></a></div>
      </article>
    </div>
    <div class="btmspace-50 center">
      <h3 class="btmspace-10"></h3>
    ...
    <div class="latest">
      <article class="clear">
        <div class="one_half first"><a class="iblock borderedbox inspace-10" href="#"><img src="asset/images/demo/ddarwin.jpg" alt=""></a></div>
        <div class="one_half">
          <h3 class="heading"></h3>
          <ul class="nospace meta">
            <li>
